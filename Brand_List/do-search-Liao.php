...
if(isset($_GET["name"])){
    $name=$_GET["name"];
    $sql = "SELECT * FROM brand WHERE brand_hostName LIKE '%$name%' AND valid=1";
...
<body>
    <div class="container">
        <form action="do-search-Liao.php">
            <div class="row mt-3">
                <div class="col">
                    <input class="form-control" type="text" name="name" placeholder="搜尋品牌聯絡人">
                </div>
                <div class="col-auto">
        ...
        <div class="mt-3 d-flex justify-content-between align-items-center">
            <a class="btn btn-dark mb-3" href="../brand_list-Lin.php?">回使用者列表</a>
            <h6>共 <?= $brandCount ?> 筆 </h6>
        </div>
