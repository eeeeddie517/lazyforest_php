		...
		<div class="sign">
			<nav class="container">
				<ul class="nav nav-tabs d-flex justify-content-center">
					<li class="nav-item flex-growth"><a class="nav-link" href="">營主註冊</a></li>
					<li class="nav-item flex-growth"><a class="nav-link" href="camp-signIn-Liao.php">營主登入</a></li>
				</ul>
			</nav>
