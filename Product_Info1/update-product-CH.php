...
if($input_product_img["error"]==0) {
    if(move_uploaded_file($_FILES["input_product_img"]["tmp_name"], "images-CH/".$_FILES["input_product_img"]["name"])){
        ...
        $sqlUpdate = "UPDATE product_info SET product_name = '$input_product_name', product_introduce = '$input_product_introduce', product_spec = '$input_product_spec', product_price = '$input_product_price', product_img = '$input_product_img_name',product_amount = '$input_product_amount' WHERE id = $id";
