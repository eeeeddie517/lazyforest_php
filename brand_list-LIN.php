    ...
    <main class="main-content ">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center border-bottom px-2">
                <h1 class="mt-3">品牌名單</h1>
                <h6>共 <?= $totalBrand ?> 筆，第<?= $page ?> 頁</h6>
            </div>

            <div class="m-3 d-flex justify-content-between">
                <!-- 搜尋bar -->
                <form action="Brand_List/do-search-Liao.php">
                    <div class="row">
                        <div class="col">
                ...
                <div class="search-btn">
                    <div class="btn-group me-2">
                        <a href="<?= $_SERVER['PHP_SELF'] ?>?page=<?= $page ?>&type=1" class="btn btn-secondary <?php if ($type == 1) echo "active"; ?> "><i class="fa-solid fa-arrow-down"></i> id</a>
                    ...
                    <div class="btn-group">
                        <a href="<?= $_SERVER['PHP_SELF'] ?>?page=<?= $page ?>&type=3" class="btn btn-secondary <?php if ($type == 3) echo "active"; ?>"><i class="fa-solid fa-arrow-down"></i> email</a>
                ...
                <tbody>
                    <?php foreach ($rows as $brand) : ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="Brand_List/brand-detail-Liao.php?id=<?= $brand["brand_id"] ?>">顯示</a></td>
